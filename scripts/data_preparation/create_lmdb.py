...
def create_lmdb_for_df2k():
    ...
    """
    # HR images
    folder_path = 'datasets/DF2K/DF2K_train_HR'
    lmdb_path = 'datasets/DF2K/DF2K_train_HR.lmdb'
    img_path_list, keys = prepare_keys_div2k(folder_path)
    make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)

    # LRx4 images
    folder_path = 'datasets/DF2K/DF2K_train_LR_bicubic/X4'
    lmdb_path = 'datasets/DF2K/DF2K_train_LR_bicubic/X4.lmdb'
    img_path_list, keys = prepare_keys_div2k(folder_path)
    make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)
