...
def main(args):
    ...
    log_file = osp.join(args.log_path, f"{args.model_name}_Urban100_{get_time_str()}.log")
    ...
    for i, img_path in enumerate(img_list_gt):
        ...
        img_restored = modcrop(img_restored, 2)
        img_gt = modcrop(img_gt, 2)

        # print(f'img_restored: {img_restored.shape}, img_gt: {img_gt.shape}')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_name', type=str, default='IMDN', help='method name')
    parser.add_argument('--gt', type=str, default='/media/sunlong/78C88475C8843402/Codes/BasicSR_torch1.8/datasets/Mod/urban100', help='Path to gt (Ground-Truth)')
    parser.add_argument('--restored', type=str, default='/media/sunlong/FC6C898C6C8941FE/SISR_Results/Comparisons/BI/IMDN_results/IMDN_x2/Urban100/x2', help='Path to restored images')
